...
## Ensemble
$WORKING_DIR/src/prepare_ensemble_scores.py --ref_dir $ensemble_dir -i $WORKING_DIR/$outdir/${prefix}${option}.output.txt
...
$WORKING_DIR/src/txt_addheader.py -i $WORKING_DIR/$outdir/${prefix}${option}.combined.output.txt -o $WORKING_DIR/$outdir/${prefix}${option}.combined.output.txt.extend

echo "The ML-GVP+ scores were provided in $WORKING_DIR/$outdir/${prefix}${option}.meta.output.txt"
$WORKING_DIR/src/metapredict.py \
